        ...
        mBtnOK.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mStartDate > mEndDate) {
                    Toast.makeText(CalendarActivity.this, R.string.error, Toast.LENGTH_LONG).show();
                    mChooseStartDate.setText(getString(R.string.start_task));
                    mChooseEndDate.setText(getString(R.string.end_task));
                } else {
                    Toast.makeText(CalendarActivity.this, getString(R.string.begin) + mStartDateTxt + getString(R.string.ending) + mEndDateTxt, Toast.LENGTH_LONG).show();
                }
            }
        });
    }
